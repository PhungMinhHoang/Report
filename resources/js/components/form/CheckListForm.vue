<template>
    <form class="checklist col-md-12" @submit.prevent="formSubmit">
        <div class="card">
...
export default {
    ...
    methods: {
        ...
        formSubmit() {
            if(this.de_tai == null || this.thoigian == null){
                this.$bvToast.toast('Bạn chưa chọn đề tài hoặc mốc thời gian', {
                        title: `Thông báo`,
                        variant: "warning",
                ...
                .then(response => {
                    EventBus.$emit("add-kpi-quy-trinh-success", response.data[0]);
