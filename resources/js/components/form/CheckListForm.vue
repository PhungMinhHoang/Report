    ...
    <b-form class="checklist" @submit.prevent="formSubmit">
        <table class="table table-bordered">
            <tr>
                ...
                <th style="width:">links lưu trữ chung</th>
            ...
            <tr>
                ...
                <td><input type="text" class="form-control" v-model="links[0]" @keyup="inputLink(0)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[1]" @keyup="inputLink(1)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[2]" @keyup="inputLink(2)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>-</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[3]" @keyup="inputLink(3)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>BM.VHT.KHCN.01/TK.01 - Ke hoach thuc hien de tai</td>
                <td>BGĐ Khối</td>
                <td><input type="text" class="form-control" v-model="links[4]" @keyup="inputLink(4)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>BGĐ Khối</td>
                <td><input type="text" class="form-control" v-model="links[5]" @keyup="inputLink(5)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td>BGĐ Khối</td>
                <td><input type="text" class="form-control" v-model="links[6]" @keyup="inputLink(6)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-7'>Sơ đồ khối thiết kế module và giao diện kết nối các khối trong module</td>
                <td>BM.VHT.KHCN.01/TK.05 - TK Module</td>
                <td>PM Đề tài</td>
                <td><input type="text" class="form-control" v-model="links[7]" @keyup="inputLink(7)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-8'>Kết quả đo, kiểm tra tính năng, chỉ tiêu kỹ thuật module</td>
                <td>-</td>
                <td>PM Đề tài</td>
                <td><input type="text" class="form-control" v-model="links[8]" @keyup="inputLink(8)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-9'>Sản phẩm sau khi lắp ráp, hiệu chỉnh</td>
                <td>-</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[9]" @keyup="inputLink(9)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-10'>List lỗi trong quá trình lắp ráp và phương án khắc phục</td>
                <td>-</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[10]" @keyup="inputLink(10)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-11'>Dự thảo tài liệu mô tả sản phẩm</td>
                <td>BM.VHT.KHCN.01/TK.04 - Mo ta san pham</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[11]" @keyup="inputLink(11)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-12'>Bài đo/phương pháp đo sản phẩm</td>
                <td>BM.VHT.KHCN.01/TK.06 - Bai do phuong phap do kiem</td>
                <td>BGĐ Khối</td>
                <td><input type="text" class="form-control" v-model="links[12]" @keyup="inputLink(12)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-13'>Kết quả đo, kiểm tra tính năng, chỉ tiêu kỹ thuật sản phẩm</td>
                <td>-</td>
                <td>QC Đề tài</td>
                <td><input type="text" class="form-control" v-model="links[13]" @keyup="inputLink(13)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-14'>Báo cáo kết quả đánh giá ATTT sản phẩm</td>
                <td>-</td>
                <td>QC Đề tài</td>
                <td><input type="text" class="form-control" v-model="links[14]" @keyup="inputLink(14)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-15'>Yêu cầu thay đổi</td>
                <td>-</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[15]" @keyup="inputLink(15)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-11'>Log QLDA</td>
                <td>BM.VHT.KHCN.01/TK.07 - Log QLDA</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[16]" @keyup="inputLink(16)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
                ...
                <td>{{temp_max_score[117]}}</td>
                <td>{{real_score[117]}}</td>
            </tr>
            <tr>
                <td rowspan="2">12</td>
                <th rowspan="2">Thử nghiệm thực tế</th>
                <td id='document-name-17'>Kế hoạch thử nghiệm thực tế</td>
                <td>BM.VHT.KHCN.01/TK.08A – Ke hoach thu nghiem thuc te</td>
                <td>Ban TGĐ</td>
                <td><input type="text" class="form-control" v-model="links[17]" @keyup="inputLink(17)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-18'>Báo cáo kết quả thử nghiệm tại đơn vị sử dụng</td>
                <td>BM.VHT.KHCN.01/TK.08B - Bien ban thu nghiem thuc te; nhật ký sử dụng, các biên bản
                    vận
                    hành</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[18]" @keyup="inputLink(18)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-19'>Báo cáo đánh giá chất lượng sản phẩm</td>
                <td>BM.VHT.KHCN.01- TK.09- Bao cao danh gia chat luong san pham</td>
                <td>-</td>
                <td><input type="text" class="form-control" v-model="links[19]" @keyup="inputLink(19)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-20'>Báo cáo kết quả nghiên cứu giai đoạn</td>
                <td>BM.VHT.KHCN.01/TK.10 - Bao cao ket qua nghien cuu giai doan</td>
                <td rowspan="5">BGĐ Khối</td>
                <td><input type="text" class="form-control" v-model="links[20]" @keyup="inputLink(20)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-21'>Báo cáo linh kiện</td>
                <td>BM.VHT.KHCN.01/TK.11 - Bieu mau bao cao linh kien</td>
                <td><input type="text" class="form-control" v-model="links[21]" @keyup="inputLink(21)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-22'>Bảng chấm công theo công việc</td>
                <td>BM.VHT.KHCN.01/TK.12 - Bieu mau theo cong viec</td>
                <td><input type="text" class="form-control" v-model="links[22]" @keyup="inputLink(22)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-23'>Báo cáo phân bổ chi phí nhân công theo nhân sự</td>
                <td>BM.VHT.KHCN.01/TK.13 - Bieu mau theo nhan su</td>
                <td><input type="text" class="form-control" v-model="links[23]" @keyup="inputLink(23)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                <td id='document-name-24'>Bảng Tổng hợp chi phí nhân công theo nhân sự</td>
                <td>BM.VHT.KHCN.01/TK.14 - Tong hop chi phi nhan cong theo nhan su</td>
                <td><input type="text" class="form-control" v-model="links[24]" @keyup="inputLink(24)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
            ...
            <tr>
                ...
                <td id='document-name-25'>Bộ hồ sơ tài liệu nghiên cứu thiết kế</td>
                ...
                <td><input type="text" class="form-control" v-model="links[25]" @keyup="inputLink(25)" placeholder="Nhập links vào đây để chấm"></td>
                <td>
...
export default {
    ...
    data(){
        return{
            ...
            links: [],
            selections: [],
            max_score: [4,1,1,1,3,5,15,10,5,5,5,5,5,14,1,1,1,1,2,5,1,1,1,1,1,5],
