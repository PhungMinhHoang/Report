        ...
        chart: {
            ...
            events: {
                drilldown: function(e) {
                    ...
                    let chart = this;
                    if (!e.seriesOptions) {
                        parent = chart.title.textStr;
                        let s = parent.indexOf('(') + 1;
                        let f = parent.indexOf(')');
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        console.log(dataLine(myObj, parent, ten_don_vi, 'chart3'))
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart3'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
                    this.setTitle({
                        text: title + '(' + ten_don_vi + ')'
                    });
                },
                drillup: function(e) {
                    let str = 'TCT';
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart4'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart5'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart6'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart7'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart8'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
            ...
            events: {
                drilldown: function(e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        parent = parent.substring(s, f);
                        ten_don_vi = e.point.name;
                        chart.addSingleSeriesAsDrilldown(e.point, dataLine(myObj, parent, ten_don_vi, 'chart9'));
                        chart.applyDrilldown();
                    } else {
                        ten_don_vi = e.seriesOptions.id.split('-')[1];
                    }
